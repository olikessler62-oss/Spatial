...
import type { CensoredRunSummary, HistoricalRunDataQuality, RunLengthFrequencyEntry, RunLengthMode, RunLengthQuantiles, RunLengthSurvivalEntry, ShapeRun } from "./shape-run.js";
...
//# sourceMappingURL=historical-shape-run-result.d.ts.map