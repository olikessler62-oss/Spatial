export type ShapeOverdueClassification = "insufficient-data" | "typical" | "elevated" | "rare" | "extreme" | "historical-maximum-matched" | "historical-maximum-exceeded";
...
export declare const DEFAULT_SHAPE_OVERDUE_EVALUATION_CONFIGURATION: ShapeOverdueEvaluationConfiguration;
export type ModeRelation = "below-all-modes" | "matches-mode" | "between-modes" | "above-all-modes";
...
export type MaximumRelation = "below-maximum" | "matches-maximum" | "exceeds-maximum";
...
export declare const SHAPE_OVERDUE_DISCLAIMER_CODES: readonly ["HISTORICAL_DESCRIPTION_ONLY", "NO_CHANGE_TO_DRAW_PROBABILITY"];
//# sourceMappingURL=shape-overdue-types.d.ts.map