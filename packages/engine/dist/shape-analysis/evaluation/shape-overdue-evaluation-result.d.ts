...
import type { AverageComparison, MaximumComparison, MedianComparison, ModeComparison, ShapeOverdueClassification, ShapeOverdueReason } from "./shape-overdue-types.js";
...
export interface ShapeOverdueBatchSummary {
    ...
    readonly classificationCounts: Readonly<Record<ShapeOverdueClassification, number>>;
...
//# sourceMappingURL=shape-overdue-evaluation-result.d.ts.map