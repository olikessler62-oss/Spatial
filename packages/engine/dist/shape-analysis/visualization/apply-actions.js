export function applyVisualizationActions(visible, catalog, actions) {
...
export function createFinalVisibleOccurrences(finalOccurrences) {
    return new Map(finalOccurrences.map((occurrence) => [
        occurrence.occurrenceKey,
        { ...occurrence, isVisible: true },
    ]));
}
//# sourceMappingURL=apply-actions.js.map