...
import { EXPERIMENT1_LAYOUT_SEED, EXPERIMENT1_SHAPES, } from "../experiment/experiment1-shapes.js";
import { analyzeShapeGaps, } from "../analysis/features/shape-gap-analysis.js";
...
export function runExperiment1ShapeGapAnalysis(options) {
    ...
    const layoutSeed = options.layoutSeed ?? `${EXPERIMENT1_LAYOUT_SEED}-${seedIndex}`;
    const shapes = EXPERIMENT1_SHAPES.filter((shape) => GAP_SHAPE_IDS.has(shape.id));
...
//# sourceMappingURL=experiment1-gap-analysis.js.map