...
export function computeArithmeticMean(values) {
    if (values.length === 0) {
        return null;
    }
 ...
 */
export function computeTrimmedMean(values, trimFraction) {
    if (values.length === 0) {
        return null;
    }
...
export function computeMinimum(values) {
    if (values.length === 0) {
        return null;
    }
    return Math.min(...values);
}
export function computeMaximum(values) {
    if (values.length === 0) {
        return null;
    }
...
//# sourceMappingURL=numeric-statistics.js.map