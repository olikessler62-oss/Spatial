 ...
 */
export function buildRollingWindows(drawCount, windowSize, stepSize) {
    if (drawCount <= 0
        || windowSize <= 0
        || stepSize <= 0
    ...
    const windows = [];
    for (let start = 0; start + windowSize - 1 < drawCount; start += stepSize) {
...
//# sourceMappingURL=rolling-window-builder.js.map