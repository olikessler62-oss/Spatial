...
} from "./german-lotto-archive.js";
import type { AcceptedDraw, ImportReport, RejectedDraw } from "./import-report.js";
...
export class CsvImportService {
  ...
  public import(
    ...
    const acceptedDraws: AcceptedDraw[] = [];
