...
export interface RollingPhaseAnalysisConfiguration
  extends RollingWindowConfiguration {
...
export const DEFAULT_ROLLING_WINDOW_CONFIGURATION: RollingWindowConfiguration =
  {
    windowSizes: [25, 50, 100],
    stepSize: 1,
  };

export const DEFAULT_ROLLING_PHASE_ANALYSIS_CONFIGURATION: RollingPhaseAnalysisConfiguration =
  {
...
export type CombinedPhasePattern =
...
export interface NumberRollingPhaseAnalysis {
  ...
  readonly windowsBySize: Readonly<
    Record<number, readonly RollingNumberWindowAnalysis[]>
  >;
  readonly currentWindows: Readonly<
    Record<number, RollingNumberWindowAnalysis | null>
  >;
