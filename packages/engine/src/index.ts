...
} from "./import/german-lotto-archive.js";
export {
  CsvImportService,
...
export {
  ...
  type WalkForwardSelection,
  type TrackedPlacement,
} from "./experiment/walk-forward-runner.js";
...
export {
  ...
  buildShapeBreakdown,
  type Experiment1Report,
  type Experiment1MultiSeedResult,
  type Experiment1SeedRunSummary,
  type Experiment1WindowMetrics,
  type SegmentSummary,
  type ShapeBreakdownRow,
} from "./experiment/experiment1-report.js";
...
export {
  ...
  type ShapeGapStats,
  type PlacementGapStats,
  type GapLengthFrequency,
} from "./analysis/features/shape-gap-analysis.js";

export {
  runExperiment1ShapeGapAnalysis,
} from "./experiment/experiment1-gap-analysis.js";

export {
  CORNER_5X5_LAYOUT_SEED,
  CORNER_5X5_SHAPES,
} from "./experiment/corner-5x5-shapes.js";

export {
  analyzeCorner5x5LatestMisses,
  type Corner5x5MissReport,
  type CornerMissedPlacement,
  type CornerMissFrequency,
} from "./experiment/corner-5x5-miss-analysis.js";

export {
  runRandomPlacementBaseline,
  empiricalPValue,
  type BaselineDistributionSummary,
} from "./experiment/baselines/random-placement-baseline.js";

export {
  runNonSpatialGroupBaseline,
} from "./experiment/baselines/nonspatial-group-baseline.js";
...
export {
  ...
  buildMissStreakStatistics,
  compareWindowToGlobal,
  computeMetricTrend,
  classifyNumberPhase,
...
} from "./analysis/rolling-phase/index.js";
export type {
...
export {
  ...
  computeMaximum,
  sortAscending,
} from "./analysis/stats/numeric-statistics.js";
...
export {
  ...
  DEFAULT_SHAPE_ANALYSIS_CONFIGURATION,
